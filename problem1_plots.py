...
# training_set = []
# training_set_labels = []
# with open("output/weights_trained.txt", "r") as f1, open("output/training_set.txt", "r") as f2, open("output/training_set_labels.txt", "r") as f3, open("output/test_set.txt", "r") as f4, open("output/test_set_labels.txt", "r") as f5:
...
with open("output/error_fractions_training.txt", "r") as f1, open("output/error_fractions_training_test_set.txt", "r") as f2:
    lines = f1.readlines()
